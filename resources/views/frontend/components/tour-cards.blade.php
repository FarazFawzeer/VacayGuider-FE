<div class="row">
    @forelse ($packages as $package)
        <div class="col-md-4 mb-4">
            <!-- Your tour card HTML (copy from your current main blade) -->
            <a href="{{ route('tour.details', $package->id) }}" class="tour-box-link"
                ...
                <div class="tour-box style2 th-ani"
                    ...
                    <div class="tour-box_img global-img" style="position: relative;">
                        <img src="{{ asset('storage/' . $package->picture) }}" alt="{{ $package->place }}"
                    ...
                    <div class="tour-content" style="padding: 15px;">
                        ...
                        <a href="{{ route('tour.details', $package->id) }}" class="text-primary small" style="font-weight: 500;">View More</a>
                    </div>

                    <div class="d-flex align-items-right" style="justify-content: right; margin-bottom: 5px; padding-right: 15px; padding-bottom: 15px;">
